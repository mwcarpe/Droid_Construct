...
public class Utils {
    ...
    public static final boolean close(float a, float b) {
        return close(a, b, EPSILON);
    }

    public static final boolean close(float a, float b, float epsilon) {
    ...
    public static final float framesToTime(int framesPerSecond, int frameCount) {
