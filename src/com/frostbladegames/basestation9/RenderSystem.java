...
//            DebugLog.d("RenderElementPool", "release()");
            ...
            if (renderable != null) {
//            	Log.i("Object", "RenderElementPool release() element.gameObjectId = " + renderable.objectId);
            	
            	if (renderable.mDrawable != null) {
//            		Log.i("Object", "RenderElementPool release() renderable.mDrawable.toString() = " + renderable.mDrawable.toString());
...
//                    super.release(element);
            		...
            		Log.e("Object", "RenderElementPool release() element.mDrawable = NULL");
            	}
            } else {
            	Log.e("Object", "RenderElementPool release() element = NULL");
            }
