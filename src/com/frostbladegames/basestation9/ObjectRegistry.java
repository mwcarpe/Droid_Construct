...
//    public LevelBuilder levelBuilder;
    ...
    public RenderSystemHud renderSystemHud;
    public SoundSystem soundSystem;
    public SpecialEffectSystem specialEffectSystem;
    public SplashScreenRenderSystem splashScreenRenderSystem;
...
//    public VibrationSystem vibrationSystem;
    ...
    public void reset() {
    	if (GameParameters.debug) {
            Log.i("Object", "ObjectRegistry reset()");	
    	}
...
//        Log.i("GameFlow", "ObjectRegistry setGamePause() pauseState = " + pauseState);
//        
