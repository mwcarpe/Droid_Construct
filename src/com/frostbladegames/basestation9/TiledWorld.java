...
//        DebugLog.d("TiledWorld", "getTile()");
    ...
    // XXX: add a checksum in here somewhere.
    protected boolean parseInput(InputStream stream) {
//        DebugLog.d("TiledWorld", "parseInput()");
        ...
        try {
            ...
            //XXX: figure out the best way to deal with this.  Assert?
        }
...
//        DebugLog.d("TiledWorld", "calculateSkips()");
