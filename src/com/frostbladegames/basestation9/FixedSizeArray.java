...
//		Log.i("Object", "FixedSizeArray <constructor> size = " + size);
...
//		Log.i("Object", "FixedSizeArray <constructor> with Comparator<T>; size = " + size);
...
//    	Log.i("Object", "FixedSizeArray add() mContents.length, mCount = " + mContents.length + ", " + mCount);	
...
//		Log.i("Object", "FixedSizeArray remove() with ignoreComparator");
...
//		Log.i("Object", "FixedSizeArray remove()");
     ...
     */
    public T removeLast() {
//		Log.i("Object", "FixedSizeArray removeLast()");
...
//		Log.i("Object", "FixedSizeArray swapWithLast()");
    ...
    /**
     * Moves the element at the passed index to end of the array.
     */
    public void moveToLast(int index) {
//		Log.i("Object", "FixedSizeArray moveToLast()");
    	
        if (mCount > 0 && index < (mCount - 1)) {
        	T objectLast = mContents[index];
        	
        	for (int i = index; i < (mCount - 1); i++) {
        		mContents[i] = mContents[i + 1];
        	}
        	
        	mContents[mCount - 1] = objectLast;
            mSorted = false;
        }
    }
...
//		Log.i("Object", "FixedSizeArray set()");
     ...
     */
    public void clear() {
//		Log.i("Object", "FixedSizeArray clear()");
...
//		Log.i("Object", "FixedSizeArray get()");
...
//		Log.i("Object", "FixedSizeArray getArray()");
...
//		Log.i("Object", "FixedSizeArray find()");
...
//		Log.i("Object", "FixedSizeArray sort()");
