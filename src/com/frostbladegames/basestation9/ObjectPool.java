...
//        Log.i("Object", "ObjectPool <constructor> DEFAULT_SIZE = 32");
    }

    public ObjectPool(int size) {
        super();
        
//        Log.i("Object", "ObjectPool <constructor> size = " + size);
...
//        DebugLog.d("ObjectPool", "allocate() mAvailable allocated = " + getAllocatedCount());
//        DebugLog.d("ObjectPool", "allocate() mAvailable count = " + mAvailable.getCount());
...
//        DebugLog.d("ObjectPool", "release() mAvailable allocated = " + getAllocatedCount());
//        DebugLog.d("ObjectPool", "release() mAvailable count = " + mAvailable.getCount());
    }
...
//        Log.i("Object", "ObjectPool setSize() size = " + size);
